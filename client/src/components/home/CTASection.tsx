      ...
      <section className="py-20 bg-gradient-to-r from-[#000000] to-[#333333] text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 max-w-3xl mx-auto mb-8">
            Partner with TCS to unlock innovation and drive business transformation that delivers tangible results.
          </p>
      ...
      <Dialog open={isConsultationDialogOpen} onOpenChange={setIsConsultationDialogOpen}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Tell us about your business challenges and our experts will schedule a personalized consultation.
            </DialogDescription>
          </DialogHeader>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            <div className="grid grid-cols-1 gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="consultation-message">Business Challenges *</Label>
                <Textarea 
