        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl">
            <p className="text-xl mb-8">
              Access financial information, reports, and resources for DWS
              ...
              <div className="mb-4">
                <div className="flex justify-between border-b border-gray-700 py-2">
                  ...
                  <span className="font-bold">
                    3,471.85 <span className="text-green-500">+1.75%</span>
                  </span>
                </div>
                <div className="flex justify-between border-b border-gray-700 py-2">
                  <span>NSE</span>
                  <span className="font-bold">
                    3,473.20 <span className="text-green-500">+1.82%</span>
                  </span>
                </div>
                <div className="text-sm text-gray-400 mt-2">
                  As of April 8, 2023 - 16:00 IST
                </div>
              </div>
                  ...
                  {financialResults.map((result, index) => (
                    <tr key={index} className="border-b border-gray-800">
                      ...
                      <td className="py-3 px-4">
                        <Link
                          href={`/investors/results/${
                            result.year
                          }/${result.quarter.toLowerCase()}`}
                        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-900 p-6 rounded-lg">
              ...
              <p className="mb-4">
                Browse our latest investor presentations and roadshows.
              </p>
